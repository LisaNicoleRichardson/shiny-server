  ...
  tabsetPanel(
    tabPanel("Metadata", 
             fluidRow(
               ...
               column(4,
                      tags$img( height = 220, width = 277, src = "C:/Data Accelerator/2015 data/Shiny/www/MMO_logo2.jpg")
               )
             ),
             fluidRow(
{column(10,
...
coastline <- read.shapefile("C:/Data Accelerator/2015 data/Shiny/Shapefiles/shape/ne_10m_coastline")
coastline2 <- read.shapefile("C:/Data Accelerator/2015 data/Shiny/Shapefiles/shape/eez_lr")
